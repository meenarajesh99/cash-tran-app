...
public class JdbcTransferDAO implements TransferDAO {
    ...
    // pulls list of all pending transfers
    @Override
    ...
    // creates new transfer record and updates user balances
    @Override
    ...
    // creates new transfer request for user being requested, no balance updates
    @Override
    ...
    // accepts transfer request, updates balances and past transfer tables
    @Override
    ...
    // cancels transfer request, updates past requests tables, does not update balances
    @Override
