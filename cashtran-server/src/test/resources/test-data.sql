...
DROP TABLE IF EXISTS transfer, account, cashtran_user, transfer_type, transfer_status;
...
CREATE TABLE cashtran_user (
	...
	CONSTRAINT PK_cashtran_user PRIMARY KEY (user_id),
...
CREATE TABLE account (
	...
	CONSTRAINT FK_account_cashtran_user FOREIGN KEY (user_id) REFERENCES cashtran_user (user_id));
...
INSERT INTO cashtran_user(username,password_hash)
